<header>
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <button
            type="button"
            class="hidden xl:flex items-center justify-center w-10 h-10 text-gray-500 border border-gray-200 rounded-lg dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 bg-gray-100 dark:bg-white/[0.03] cursor-default"
            ...
            <div class="hidden xl:block">
                <div class="relative">
                    ...
                    <div class="absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400 select-none">
                        <span> ⌘ </span>
                        <span> K </span>
                    </div>
                </div>
